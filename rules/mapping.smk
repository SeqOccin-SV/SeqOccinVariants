...
rule bam_sort:
	input:
		"mapping/{sample}-{tech}-pbmm2-unsorted.bam"
	output:
		"mapping/{sample}-{tech}-pbmm2.bam"
	log:
		"logs/samtools/{sample}-{tech}-sort.log"
	conda:
...
rule bam_index:
	input:
		"mapping/{sample}-{tech}-pbmm2.bam"
	output:
		"mapping/{sample}-{tech}-pbmm2.bam.bai"
	log:
		"logs/samtools/{sample}-{tech}-index.log"
	conda:
		'../envs/samtools_env.yaml'
